...
from user_commands.command_api import CommandRuntimeError
    ...
    def start_listening(self,callback_with_data):
        ...
        while True:
            try:
                ...
                data_dict,is_util = reactor.get_react_func(user_input)()
                if not is_util:
                    encoded_data = encode_data(data_dict)
                    callback_with_data(encoded_data)

            except PrintHelpException as he:
                print(he)

            except CommandRuntimeError as runtimee:
