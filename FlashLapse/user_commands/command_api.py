...
class CommandCMDLInput(object):
	...
	def _is_util_(self):
		'''Overrideable: Default is False
		This method decides whether this command is a util method
		only for the cmdl and do not need to send data to the backend
		'''
